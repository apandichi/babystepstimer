    ...
    public void hyperlinkUpdate(final HyperlinkEvent e) {
        if(e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
            if("command://start".equals(e.getDescription())) {
                ...
                babystepsTimer.setText(htmlCreator.createTimerHtml(BabystepsTimer.getRemainingTimeCaption(0L), BabystepsTimer.BACKGROUND_COLOR_NEUTRAL, true));
                ...
                babystepsTimer.setText(htmlCreator.createTimerHtml(BabystepsTimer.getRemainingTimeCaption(0L), BabystepsTimer.BACKGROUND_COLOR_NEUTRAL, false));
                babystepsTimer.repaint();
